...
save(sim_table,Ne_estimates, Fc_multilocus,Ne_estimatesMAF,Fc_multilocusMAF,file="EffectivePopSizeMAF.RData")
...
#load(file="EffectivePopSizeMAF.RData")
...
pdf_file_name <- paste0("EffectivePopSizeMAF_s",sel_coef,"_dT",selection_period_duration,"_sigma",sigma_value,".pdf")
...
pdf_file_name <- paste0("EffectivePopSizeMAF_s",sel_coef,"_dT",selection_period_duration,".pdf")
pdf(file=pdf_file_name)
